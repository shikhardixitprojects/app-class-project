    ...
    return (
      <body>
        <div className="App">
          ...
          <p className = "LakeView"> LakeView is a chinese resturant that serves chinese food. It is typcially quite empty, but it seems most of the customers order from here than go here. Still, it has quality food and pretty cheap. Rating 4/5</p>
          ...
          <p className = "AppleBee"> AppleBee is a family resturant that serves your typical amercian food. It's usually very packed and you might need to wait some time before being allowed in. But if you just want a classic american resturant, this would be the place with family or friends. Rating 4.5</p>
